...
/**
 * Fetch a custom path from the api
 */
Data.prototype.customPath = function customPath (path, args, instance) {
 ...
 * @param  {String} args.namespace    The game data namespace
 * @param  {Number} args.realm        The connected realm id
 * @param  {Number} [args.raid]       The slug of the raid to look up
 * @param  {Number} [args.faction]    The name of the faction's leaderboard to look up
 * @param  {String} [args.origin]     The region key
 * @param  {String} [args.locale]     A locale code for this region
 * @param  {Object} [instance]        An [axios](https://github.com/mzabriskie/axios) compatible instance configuration
 * @return {Promise}                  A thenable Promises/A+ reference
 */
Data.prototype.mythicRaidLeaderboard = function mythicRaidLeaderboard (args, instance) {
  const params = { namespace: args.namespace || `dynamic-${args.origin}` };

  return this.blizzard.get(`/data/wow/leaderboard/hall-of-fame/${args.raid}/${args.faction}`, Object.assign({}, args, { params }), instance);
};
 ...
 * @return {Promise}                  A thenable Promises/A+ reference
 */
Data.prototype.mythicChallengeMode = function mythicChallengeMode (args, instance) {
  const params = { namespace: args.namespace || `dynamic-${args.origin}` };
