...
Blizzard.prototype.fetchToken = function fetchToken (origin, params) {
  ...
  return this.axios.post(`https://${origin}.battle.net/oauth/token?grant_type=${encodeURIComponent(grant_type)}&client_id=${encodeURIComponent(client_id)}&client_secret=${encodeURIComponent(client_secret)}`);
};
