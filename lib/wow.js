 ...
 * Fetch auctions
 */
WoW.prototype.auctions = function auctions (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/data/wow/connected-realm/${args.id}/auctions`, Object.assign({}, args, { params }), instance);
};
 ...
 */
WoW.prototype.accountProfile = function accountProfile (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/profile/user/wow`, Object.assign({}, args, { params }), instance);
};
 ...
 * Retrieve account profile
 */
WoW.prototype.accountProtectedCharacterProfile = function accountProtectedCharacterProfile (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}`, region: args.region };
  return this.blizzard.get(`/profile/user/wow/protected-character/${args.realmId}-${args.characterId}`, params, instance);
};
 ...
 * Game Data API
 *
 * Retrieve character profile status
 */
WoW.prototype.characterProfileStatus = function characterProfileStatus (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/profile/wow/character/${args.realm.toLowerCase()}/${args.character.toLowerCase()}/status`, Object.assign({}, args, { params }), instance);
};
 ...
 * Game Data API
 *
 * Retrieve character achievements summary
 */
 ...
 * Game Data API
 *
 * Retrieve character achievement statistics
 */
WoW.prototype.characterAchievementStatistics = function characterAchievementStatistics (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/profile/wow/character/${args.realm.toLowerCase()}/${args.character.toLowerCase()}/achievements/statistics`, Object.assign({}, args, { params }), instance);
};
 ...
 * Game Data API
 *
 * Retrieve character dungeons
 */
WoW.prototype.characterDungeons = function characterDungeons (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/profile/wow/character/${args.realm.toLowerCase()}/${args.character.toLowerCase()}/encounters/dungeons`, Object.assign({}, args, { params }), instance);
};

/**
 * Game Data API
 *
 * Retrieve character raids
 */
WoW.prototype.characterRaids = function characterRaids (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/profile/wow/character/${args.realm.toLowerCase()}/${args.character.toLowerCase()}/encounters/raids`, Object.assign({}, args, { params }), instance);
};

/**
 * Game Data API
 *
 * Retrieve character soulbinds
 */
WoW.prototype.characterSoulbinds = function characterSoulbinds (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/profile/wow/character/${args.realm.toLowerCase()}/${args.character.toLowerCase()}/soulbinds`, Object.assign({}, args, { params }), instance);
};

/**
 * Game Data API
 *
 * Retrieve guild summary
 */
WoW.prototype.guildSummary = function guildSummary (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/data/wow/guild/${args.realm}/${args.guild}`, Object.assign({}, args, { params }), instance);
};

/**
 * Game Data API
 *
 * Retrieve guild activity
 */
WoW.prototype.guildActivity = function guildActivity (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/data/wow/guild/${args.realm}/${args.guild}/activity`, Object.assign({}, args, { params }), instance);
};

/**
 * Game Data API
 *
 * Retrieve guild achievements
 */
WoW.prototype.guildAchievements = function guildAchievements (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/data/wow/guild/${args.realm}/${args.guild}/achievements`, Object.assign({}, args, { params }), instance);
};

/**
 * Game Data API
 *
 * Retrieve guild roster
 */
WoW.prototype.guildRoster = function guildRoster (args, instance) {
  const params = { namespace: args.namespace || `profile-${args.origin}` };
  return this.blizzard.get(`/data/wow/guild/${args.realm}/${args.guild}/roster`, Object.assign({}, args, { params }), instance);
};
